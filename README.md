...
4. **当前已完成关卡：** `levels/00-first-click`、`levels/01-python-cli`、`levels/02-editor-and-files`；**下一关：** 第 03 关（见下表）。
...
| 第 03 关：HTML / CSS / JavaScript 基础 | 规划中（下一关） | `levels/03-html-css-js` |
| 第 04–13 关 | 规划中 | 见 `levels/` 与 [`COURSE_DESIGN_STANDARD.md`](docs/00-overview/COURSE_DESIGN_STANDARD.md) |
